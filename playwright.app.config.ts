...
export default defineConfig({
  ...
  workers: 2,
  use: { baseURL: target || 'http://127.0.0.1:4175', viewport: { width: 1100, height: 1100 }, reducedMotion:'reduce', trace: 'retain-on-failure', video: 'on', screenshot: 'only-on-failure' },
