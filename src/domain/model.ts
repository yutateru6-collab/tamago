...
export interface Memory { id: string; at: number; title: string; detail: string; kind: 'discovery' | 'craft' | 'growth' | 'event' }
export interface World {
  ...
  restEvents?: { minutes: number; enjoyed: Record<string, number> };
}
